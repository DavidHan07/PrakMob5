package com.example.prak5_145.adapter;
...
import com.example.prak5_145.MainActivity;
import com.example.prak5_145.MapsActivity;
import com.example.prak5_145.R;
...
public class CustomHomeAdapter extends RecyclerView.Adapter<CustomHomeAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        holder.tv_object.setText(data.get(position).getJudul());//ambildata
